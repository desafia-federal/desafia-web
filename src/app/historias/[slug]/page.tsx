      ...
      <article>
        ...
        <div className="article-body">
          ...
          <aside className="article-source-note">
            Este texto es una redacción original de DESAFÍA Federal. Sus ideas
            dialogan con el enfoque de derechos de CommunicationFIRST y con el
            concepto de accesibilidad comunicacional desarrollado por CDAC.
          </aside>
        </div>
      </article>
      <CtaBand />
